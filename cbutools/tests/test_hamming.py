...
def test_map2d():
    ...
    out = cbu.hamming.map2d(x, y, lambda a, b: a * b)
...
def test_map2d_sym():
    ...
    out = cbu.hamming.map2d(x, x, lambda a, b: a * b, symmetry=True)
...
def test_hamming(monkeypatch):
    ...
    keep, reject, tie = cbu.hamming.hamming_filter(x, min_distance=4)
